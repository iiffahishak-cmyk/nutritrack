...
class SpoonacularController extends Controller
{
    ...
    public function listItems(Request $request)
    {
        ...
        return view('admin.spoonacular.food-items', compact('items', 'filterCounts'));
    }

    // ──────────────────────────────────────────────────────────────────────
    //  PATCH /admin/food-items/{id}/verify
    //  Admin approves one item and adds it to meals table
    // ──────────────────────────────────────────────────────────────────────
    ...
    //  Bulk verify all pending items and add them to meals table
    // ──────────────────────────────────────────────────────────────────────
